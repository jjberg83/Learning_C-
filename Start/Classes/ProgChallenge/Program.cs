...
namespace ProgChallenge
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine($"FirstName is {checking.FirstName}");
            // Console.WriteLine($"LastName is {checking.LastName}");
            // Console.WriteLine($"AccountOwner is {checking.AccountOwner}");
            Console.WriteLine($"Checking balance is {checking.Balance:C2}");

            // Console.WriteLine("---------------------------------");

            // Console.WriteLine($"FirstName is {saving.FirstName}");
            // Console.WriteLine($"LastName is {saving.LastName}");
            // Console.WriteLine($"AccountOwner is {saving.AccountOwner}");
            // Console.WriteLine($"InterestRate is {saving.InterestRate}");
