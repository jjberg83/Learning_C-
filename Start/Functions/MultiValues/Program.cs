...
namespace MultiValues
{
    class Program
    {
        /* Tuples  i stedet for out blant parameterene når man skal
        returnere multiple returnere flere return values. Dette er den
        nye måten å gjøre det på. Legacy måten er å bruke out keyword
        blant parameterene (se RefAndOutParams)*/
